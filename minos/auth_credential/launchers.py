...
class EntrypointLauncher:
    ...
    def __init__(self, config: CredentialConfig, services: tuple, *args, **kwargs):
        self.config = config
    ...
    def launch(self) -> NoReturn:
        ...
        """
        logger.info("Starting Credential service...")
        with self.entrypoint as loop:
            logger.info("Credential service is up and running!")
            loop.run_forever()
